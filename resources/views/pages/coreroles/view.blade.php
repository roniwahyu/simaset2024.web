...
<?php
    $pageTitle = "Core Role Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Core Role Details</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="page-data">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a class="btn btn-sm btn-success has-tooltip "   title="Edit" href="<?php print_link("coreroles/edit/$rec_id"); ?>" >
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" title="Delete" href="<?php print_link("coreroles/delete/$rec_id?redirect=coreroles"); ?>" >
