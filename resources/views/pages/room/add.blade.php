...
<?php
    $pageTitle = "Add New Room"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Room</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form id="room-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('room.store') }}" method="post">
                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="building_id">Building Id </label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-building_id-holder" class=" ">
                                                <select data-endpoint="<?php print_link('componentsdata/building_id_option_list') ?>" id="ctrl-building_id" data-field="building_id" name="building_id"  placeholder="Select a value ..."    class="selectize-ajax" >
