...
<?php
    $pageTitle = "Add New Employee"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Employee</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="employees-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('employees.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-departmentid-holder" class=" ">
                                                <input id="ctrl-departmentid" data-field="departmentid"  value="<?php echo get_value('departmentid') ?>" type="number" placeholder="Enter Departmentid" step="any"  required="" name="departmentid"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jobrole-holder" class=" ">
                                                <input id="ctrl-jobrole" data-field="jobrole"  value="<?php echo get_value('jobrole') ?>" type="text" placeholder="Enter Jobrole"  required="" name="jobrole"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-country-holder" class=" ">
                                                <input id="ctrl-country" data-field="country"  value="<?php echo get_value('country') ?>" type="text" placeholder="Enter Country"  name="country"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-address-holder" class=" ">
                                                <textarea placeholder="Enter Address" id="ctrl-address" data-field="address"  rows="5" name="address" class=" form-control"><?php echo get_value('address') ?></textarea>
